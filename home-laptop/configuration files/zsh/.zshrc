...
alias gitcomnew='cd ~ && cd .goral20-files && git init && git add . -A && git commit -v && cd ..'
alias gitcomold='cd ~ && cd .goral20-files && git init && git add . -A && git commit -C HEAD --amend && cd ..'
